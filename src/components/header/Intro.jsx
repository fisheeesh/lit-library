            ...
            <div className="container px-4 mx-auto">
                <div className="flex justify-center">
                    <div className="max-w-3xl text-center">
                        <h2 className={`tracking-wide mb-4 text-3xl font-bold md:text-4xl ${isDark ? 'text-light' : 'text-dark'}`}>
                            Creating <span className="text-secondary">Inspiring</span> Spaces for Growth
                        </h2>
                        <p className={`text-lg tracking-wide ${isDark ? 'text-light' : 'text-dark'}`}>
