        ...
        <div className="w-full max-w-lg px-5 mx-auto mt-16 md:px-0">
            <form onSubmit={handleSubmit(logInUser)} className={`px-8 pt-6 pb-8 mb-4 rounded ${isDark ? 'bg-dbg shadow-custom-white' : 'bg-white drop-shadow-lg'}`}>
                ...
                <div className="mb-4">
                    ...
                    <input {...register('email')} className={cn(errors.email && 'border-red-500 placeholder:text-red-500', 'w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline')} id="email" type="text" placeholder="Email" />
                    {errors.email &&
