...
export default function SingleNoti({ noti, setIsOpen }) {
    ...
    return (
        <div onClick={() => {
            ...
            {noti.isAnnouncement ? <GrAnnounce className="absolute text-amber-500 size-5 left-12 top-10" /> : noti.isComment ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`absolute ${isDark ? 'text-light' : 'text-blue-500'} size-5 left-12 top-9`}>
