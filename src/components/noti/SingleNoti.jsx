...
export default function SingleNoti({ noti, setIsOpen }) {
    ...
    return (
        <div onClick={() => {
            ...
            </div> : noti.isComment ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`absolute ${isDark ? 'text-gray-400' : 'text-blue-500'} size-5 left-10 md:left-12 top-9`}>
