...
export default function ProfileHeader({ uId }) {
    ...
    return (
        <div className="px-5 md:px-0">
                ...
                <div className="flex justify-start col-span-3 gap-4 md:col-span-2">
                    ...
                    <div className="mt-2.5">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                            ...
                            <h3 className={`text-md ${isDark ? 'text-white' : ''}`}>Email: {userData?.email}</h3>
                        </div>
                        <div className="flex items-center gap-2 mt-2">
                            <span className={`material-symbols-outlined ${isDark ? 'text-white' : ''}`}>
                                Schedule
            ...
            {<h1 className={`mt-8 mb-3 text-3xl font-bold ${isDark ? 'text-light' : 'text-dark'}`}>{currnetUser ? 'My' : userData?.displayName + '\'s'} <span className="text-primary">Library</span> 📚</h1>}
