    ...
    return (
        <form onSubmit={addComment}>
            ...
            <div className="flex items-center gap-2">
                <button type="submit" className='flex items-center gap-2 px-5 py-2.5 mt-3 mb-3 text-white transition duration-1000 ease-out rounded-full bg-primary md:px-5 hover:bg-indigo-500'>
                ...
                {type === 'update' && <button onClick={() => setEditCmt(null)} type="button" className='hover:bg-primary hover:text-white px-5 py-2.5 mt-3 mb-3 transition duration-1000 ease-out border rounded-full text-primary border-primary md:px-5'>
                    <span>Cancel</span>
                </button>}
            </div>
        </form>
