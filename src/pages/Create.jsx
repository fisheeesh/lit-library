  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-lg pt-5 mx-auto">
      <div className="flex flex-wrap mb-6 -mx-3">
        ...
        <div className="w-full px-3 md:w-1/2">
          <label className="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" htmlFor="book-author">
            Author
          </label>
      ...
      <div className="flex flex-wrap mb-3 -mx-3">
        <div className="w-full px-3">
          <label className="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" htmlFor="book-des">
            Description
          </label>
      ...
      <div className="flex flex-wrap mb-3 -mx-3">
        <div className="w-full px-3">
          <label className="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" htmlFor="book-cate">
            Categories
          </label>
          ...
          <div className="mt-1 mb-3 space-x-2 flex-flex-wrap">
            {
              categories.map((cate, index) => (<span key={index} className="px-3 py-2.5 border rounded-md border-primary">{cate}<span className="text-red-600 cursor-pointer ms-3" onClick={() => deleteCategory(cate)}>&#10006;</span></span>))
            }
          </div>
        </div>
      </div>
