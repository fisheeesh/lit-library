    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center mt-16 mb-4 space-y-4">
                <h1 className={`text-5xl font-bold text-center ${isDark ? 'text-light' : 'text-dark'} tracking-wide`}>
                    Your Daily Dose of <span className="text-secondary">Inspiration</span> and <span className="text-secondary">Knowledge</span>
                </h1>
                <h3 className={`${isDark ? 'text-light' : 'text-dark'} text-lg tracking-wide`}>
            ...
            <div className="flex items-center justify-center gap-2 px-5 mb-12">
                <input
                    ...
                    type="text"
                    className="px-5 py-4 text-lg transition duration-500 ease-in-out border border-gray-500 rounded-2xl outline-none w-[300px] sm:w-[500px] md:w-[700px] border-1 focus:border-primary"
                ...
                <div className="relative flex flex-col items-center rounded-lg w-[190px]">
                    <button
                        ...
                        className="text-sm text-light flex items-center justify-between w-full p-2.5 font-bold tracking-wider duration-300 bg-primary border-4 border-transparent rounded-2xl active:border-white active:text-white"
                    >
